...
class Step1_Mean_RMS_2013(CommonFSQFramework.Core.ExampleProofReader.ExampleProofReader):
...
if __name__ == "__main__":
   ...
   # nWorkers = 1
    ...
    Step1_Mean_RMS_2013.runAll(treeName="MuonCastorVTwo",
           slaveParameters=slaveParams,
           sampleList=sampleList,
           maxFilesMC = maxFilesMC,
           maxFilesData = maxFilesData,
           nWorkers=nWorkers,
           outFile = "output/mean_rms_2.root" ) #2013 mean_RMS_2, for 2015 mean_RMs
