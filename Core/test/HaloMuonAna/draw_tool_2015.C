...
double GetTrasposeValues(int isec, int imod)
{
  double gain[16][14] ={{17.8879, 13.2482, 14.0743, 13.3278, 2.12091, 2.12543, 3.21527, 2.98481, 2.11992, 2.06513, 2.10162, 4.18052, 2.10162, 2.10162}
                        ...
                        {13.8189, 13.0366, 12.7392, 14.4154, 2.14965, 2.13784, 2.99889, 3.00984, 2.09463, 2.09944, 2.10162, 0.507937, 2.24675, 2.14433}
                        {14.1375, 14.3402, 12.6179, 14.1134, 2.14431, 3.17871, 2.99728, 3.23413, 2.10955, 2.10675, 2.0835, 6.92593, 1.99355, 2.31884}
                        {13.8083, 13.8735, 13.0352, 13.8626, 2.00958, 3.24663, 3.18717, 3.15437, 2.09151, 2.11572, 2.21586, 2.13531, 2.51007, 2.03081}
                        {15.0498, 14.8564, 12.6001, 13.3532, 2.00998, 3.29454, 3.17426, 3.14376, 2.0985, 2.09938, 2.12139, 2.10162, 2.10162, 1.72961}
                        {13.4029, 14.6153, 13.4451, 13.2316, 2.12537, 3.18277, 3.21792, 3.06312, 2.16952, 2.08848, 2.10162, 1.15108, 2.10162, 1.96429}
                        {13.8487, 14.6547, 13.9845, 14.004, 2.16241, 1.98043, 3.01777, 3.02263, 2.12504, 2.16387, 1.9798, 2.0, 2.21538, 2.10162}
                        {13.5454, 14.1516, 11.5071, 14.1275, 2.08736, 2.11662, 3.24957, 3.10665, 2.13867, 2.04457, 2.22083, 2.04405, 1.98608, 1.98802}
                        {13.3621, 14.021, 13.4167, 11.0612, 2.15244, 3.14066, 3.13056, 3.04276, 2.04811, 2.10842, 2.125, 3.80645, 1.75349, 5.33108}
                        {13.4709, 14.0436, 13.4366, 14.2121, 2.12454, 3.20622, 2.99075, 3.13996, 2.06635, 2.07508, 2.31579, 2.23828, 2.27638, 2.10162}
                        {13.2229, 13.5576, 13.6674, 14.794, 2.00953, 2.97605, 3.12361, 3.20957, 2.08386, 2.10041, 0.850949, 2.31136, 4.57522, 2.21341}
                        {13.4984, 13.0597, 13.3461, 13.7108, 2.1543, 3.24794, 2.89888, 3.05443, 2.07617, 2.12138, 2.25668, 2.10459, 2.3318, 2.07519}};
...
{
  double gain_error[16][14] = { {0.297684, 0.303952, 0.154135, 0.143911, 0.00635945, 0.00696305, 0.013834, 0.0321267, 0.0131778, 0.00933203, 0.0500715, 0.202872, 0.0500715, 0.0500715}
                                {0.273256, 0.160228, 0.139015, 0.313545, 0.00771067, 0.00761597, 0.0624354, 0.0248926, 0.0202406, 0.00548391, 0.00676534, 0.234323, 0.0500715, 0.0500715}
                                ...
                                {0.154156, 0.153823, 0.119356, 0.202521, 0.00716295, 0.0070185, 0.0120852, 0.0464483, 0.00874689, 0.0116634, 0.0500715, 0.151539, 0.377385, 0.410735}
                                {0.184748, 0.160822, 0.393225, 0.178964, 0.00593741, 0.0110238, 0.017487, 0.0232038, 0.00917938, 0.0107265, 0.0160861, 0.356823, 0.0939621, 0.0386872}
                                {0.157523, 0.175195, 0.16801, 0.105009, 0.0290363, 0.0117636, 0.0212775, 0.022056, 0.0157854, 0.0104235, 0.194334, 0.206459, 0.261539, 0.0521384}
                                {0.151579, 0.143932, 0.135856, 0.171023, 0.253775, 0.0283761, 0.0237112, 0.0268974, 0.0142285, 0.0211197, 0.067731, 0.0500715, 0.0500715, 0.336312}
                                {0.163748, 0.161818, 0.181251, 0.253084, 0.00782319, 0.0146442, 0.0318485, 0.0249402, 0.00646081, 0.0111822, 0.0500715, 0.189923, 0.0500715, 0.653284}
                                {0.238548, 0.188285, 0.12227, 0.172699, 0.00682779, 0.00786426, 0.0209686, 0.0204322, 0.0101018, 0.0140415, 0.221228, 0.0962536, 0.365371, 0.0500715}
                                ...
                                {0.115767, 0.173322, 0.126637, 0.12721, 0.00871158, 0.00985697, 0.0232185, 0.0220267, 0.00926294, 0.0144162, 0.0723647, 0.171277, 0.0925839, 0.208289}
...
void GetMuonSignalHist(TH1F* h[16][14],TFile* file)
{
  ...
  for(int isec=0; isec<16; isec++) {
    for(int imod=0; imod<14; imod++) {
      sprintf(name,"data_MinimumBias_MuonHLTSkim_Run2015A/MuonSignalSecCh_Excl8_mod_%d_sec_%d",imod+1,isec+1);
...
void GetMeanDistributionHist(TH1F* h[16][14], TFile* file) 
{
  ...
  for(int isec=0; isec<16; isec++) {
    for(int imod=0; imod<14; imod++) {
      sprintf(name,"data_MinimumBias_MuonHLTSkim_Run2015A/1DSignalMCCh_mod_%d_sec_%d",imod+1,isec+1);
...
void draw_tool_2015(bool sigma_with_toymc = true)
{
  ...
  TFile * file = TFile::Open("/home/lxadmin/Desktop/Halomuon/d7Nov/muons_8_9.root");
  TFile * mcfile = TFile::Open("d7Nov/output_for_toyMC.root");
